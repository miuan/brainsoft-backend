...
export const userSchema: Schema = new Schema(
    {
		...
		_pokemon: {type: [Schema.Types.ObjectId], ref: 'server_Pokemon', index: true},
		_evolution: {type: [Schema.Types.ObjectId], ref: 'server_Evolution', index: true},
		_pokemonType: {type: [Schema.Types.ObjectId], ref: 'server_PokemonType', index: true},

...
export async function updateAdminUser(rawPassword = false) {
    const admin_email = process.env.ADMIN_EMAIL || `admin@admin.test`
    const admin_pass = process.env.ADMIN_PASSWORD || `admin@admin.test`
